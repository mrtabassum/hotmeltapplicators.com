				...
				<div class="col-md-6 col-lg-4">
					<div class="footer-widget recent-post-widget">
						...
						<ul class="post-list">
							...
							<i  style="color: white;" class="fas fa-angle-double-right"> 0342-4230979</i> </br>
							<i  style="color: white;" class="fas fa-angle-double-right"> 0300-0580038</i> </br>
							
							<i style="color: white;" class="fas fa-angle-double-right"> info@khawajaengineering.com</i>
